     ...
     methods: {
          ...
          previewImage(event, index) {
               ...
               if (input.files) {
                    ...
                    reader.onload = (e) => {
                         this.question.qstImages[index].preview =
                              e.target.result;
                    };
               ...
               <div v-if="question.isQcm">
                    <div>
                         <div class="d-flex justify-content-start m-4">
                              <div class="space-x-2">
                                   <div
                                        class="form-check form-switch form-check d-flex"
                                   >
                                        <div style="margin-right: 65px">
